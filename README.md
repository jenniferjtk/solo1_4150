...
Design choices: I used an earth tone color scheme with greens and off-whites to match the environmental theme. I kept the general format close to the original starter code in terms of spacing and layout. 
